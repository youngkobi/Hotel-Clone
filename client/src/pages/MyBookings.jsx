...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Easily manage your past, current, and upcoming hotel reservatioins in one place. Plan your trips seamlessly with just a few clicks"
        align="left"
      />
            ...
            w-full border-b border-gray-300 py-6 first:border-t">
                ...
                <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                    ...
                    <div className="flex flex-col items-start justify-center pt-3">
                        ...
                        {!booking.isPaid && (
                            <button className="
                           px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-200 transition-all cursor-pointer ">Pay now</button>
                        )}
                    </div>
            </div>
        ))}
