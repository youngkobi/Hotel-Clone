...
const Hero = () => {
  return (
    ...
    bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <h1 className='text-2x1 font-playfair  md:text-5x1 md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover your perfect Destination</h1>
        <p className=' max-w-130 mt-2 text-sm md:text-base'>Luxury Comfort await at the world's most excluive hotels and resorts. Start your jounrey today.</p>
